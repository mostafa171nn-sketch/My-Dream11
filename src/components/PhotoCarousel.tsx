  ...
  return (
    <section className="py-16 bg-gradient-to-b from-gray-100 to-gray-200 dark:from-[#0f172a] dark:to-[#0f172a]">
      ...
      <div className="container mx-auto px-4">
        ...
        >
          {/* Main Image Display */}
          <div className="relative overflow-hidden rounded-2xl shadow-2xl aspect-[16/9] bg-gray-200">
          ...
          <button
            onClick={prevSlide}
            className="absolute left-4 top-1/2 -translate-y-1/2 bg-white/90 hover:bg-white text-gray-800 p-3 rounded-full shadow-lg transition-all duration-300 hover:scale-110 group"
            aria-label="Previous slide"
          >
            <svg className="w-6 h-6 group-hover:text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <button
            onClick={nextSlide}
            className="absolute right-4 top-1/2 -translate-y-1/2 bg-white/90 hover:bg-white text-gray-800 p-3 rounded-full shadow-lg transition-all duration-300 hover:scale-110 group"
