    ...
    <footer className="bg-gradient-to-r from-blue-600 to-cyan-500 dark:from-gray-900 dark:to-gray-800 text-white py-10 relative overflow-hidden">
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          {/* Quick Links */}
          <div>
            <h5 className="text-white text-sm font-semibold uppercase mb-4 text-center">{t('quickLinks')}</h5>
          ...
          {/* Social Media */}
          <div>
            <h5 className="text-white text-sm font-semibold uppercase mb-4 text-center">{t('followUsFooter')}</h5>
            <ul className="space-y-2">
              <li>
                <a 
          ...
          {/* Branches */}
          <div>
            <h5 className="text-white text-sm font-semibold uppercase mb-4 text-center">{t('ourBranches')}</h5>
            <ul className="space-y-2">
              <li>
        ...
        <div className="border-t border-white/20 mt-8 pt-6">
          <div className="text-center">
            <span className="text-md ">
             <Link href="/" className="text-white/80">{t('createdBy')}</Link>
            </span>
            <p className="text-sm flex items-center justify-center gap-2 mt-2 text-white/80">
